function calculate() {
  ...
  if (pSize == "0.5" || pSize == 1 || pSize == "0.75" && schedule == "XH") {
    var cutTime = 1;
    var thrdTime = 3;
    var grvTime = 5
    var totalTime = ((cutTime * cuts + thrdTime * thrds + grvTime * grv) + buffer)
  ...
  if (pSize == "1.5" || pSize == 2 || pSize == "1.25" || pSize == "2.5" && schedule == "XH") {
    var cutTime = 1;
    var thrdTime = 4;
    var grvTime = 1;
    var totalTime = ((cutTime * cuts + thrdTime * thrds + grvTime * grv) + buffer)
  ...
  if (pSize == 3 || pSize == 4 && schedule == "XH") {
    var cutTime = 2;
    var thrdTime = 6;
    var grvTime = 5;
    var totalTime = ((cutTime * cuts + thrdTime * thrds + grvTime * grv) + buffer)
  ...
  if (pSize == 5 || pSize == 6 && schedule == "XH") {
    var cutTime = 5;
    var thrdTime = 6;
    var grvTime = 6;
    var totalTime = ((cutTime * cuts + thrdTime * thrds + grvTime * grv) + buffer)
  ...
  if (pSize == 8 || pSize == 10 && schedule == "XH") {
    var cutTime = 5;
    var thrdTime = 7;
    var grvTime = 15;
    var totalTime = ((cutTime * cuts + thrdTime * thrds + grvTime * grv) + buffer)
